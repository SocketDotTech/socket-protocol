...
contract Bridge is Script {
    ...
    function run() external {
        ...
        SuperTokenLockableAppGateway gatewayContract = SuperTokenLockableAppGateway(
            gateway
        );
        SuperTokenLockableDeployer deployerContract = SuperTokenLockableDeployer(
            deployer
        );
        ...
        SuperTokenLockableAppGateway.UserOrder memory order = SuperTokenLockableAppGateway.UserOrder({
