 ...
 */
contract CCTPSuperTokenTest is AppGatewayBaseSetup {
    /**
     ...
     */
    function testCCTPContractDeployment() public {
     ...
     */
    function testCCTPTransfer() public {
        deploySuperToken(arbChainSlug);
