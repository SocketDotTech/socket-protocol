...
import {SuperToken} from "./apps/app-gateways/super-token/SuperToken.sol";
...
contract DigestTest is Test {
    ...
    */
    ...
    function testDeploy() pure public {
        // bytes4 selector = SuperToken.setOwner.selector;
        // console.log("selector for SuperToken.setOwner.selector");
        // console.logBytes4(selector);

        bytes32 superTokenEvm = keccak256(abi.encode("superTokenEvm"));
        console.log("super token contract id:");
